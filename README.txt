...
Introduction
	...
	The programming mode are defined as three sub states: the select size, select time and confirm, as described in class, 
		You could exam if you enter a state successful via examine if there are 3 LEDs are light up, and Once you enter confirm state, the blue light would start blink.
